...
class MetaCorgiSnacks
  ...
  # def method_missing(name, *args)
    # Your code goes here...
    # method_info = 'get_' + name.to_s + '_info'
    # method_tastiness = 'get_' + name.to_s + '_tastiness'
...
# p MetaCorgiSnacks.define_snack("bone")
p snack_box = SnackBox.new
p meta_snacks = MetaCorgiSnacks.new(snack_box, 1)
